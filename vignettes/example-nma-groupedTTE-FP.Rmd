---
title: 'Bayesian FE & RE fractional polynomial NMA for grouped survival data'
author: "Sandro Gsteiger"
date: "`r Sys.Date()`"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Bayesian FE & RE NMA using FP model (example)}
...
## Introduction
This vignette provides a short example of a Bayesian NMA for GSD data. The model fit relies on the `gemtc` package, pre- and post-processing is done with `gemtcPlus`. 
